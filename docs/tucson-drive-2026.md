...
### Day 7 — Fri Aug 21 · → Chinle, AZ (Canyon de Chelly)
~230 mi, 4.5 hr · Four Corners Monument → **Monument Valley** (Navajo Tribal Park, the 17-mi valley drive) → Chinle.
Late afternoon: Canyon de Chelly's South Rim Drive to Spider Rock Overlook. Night: Chinle.

### Day 8 — Sat Aug 22 · → Petrified Forest NP → Holbrook/Flagstaff
~180 mi park-to-park
Morning: **White House Trail** (2.5 mi, the one self-guided descent into the canyon) — go early, it's exposed.
Afternoon: **Petrified Forest NP** — enter at the north (Painted Desert) end, drive the 28-mi road south, stop at Blue Mesa, Crystal Forest, Giant Logs. Night: Holbrook (Wigwam Motel, if you want the Route 66 version) or Flagstaff.

### Day 9 — Sun Aug 23 · → Tucson
~320 mi, 6 hr · US-60 through **Salt River Canyon** — a 2,000-ft switchbacked gorge people call the mini Grand Canyon. Not an interstate; budget the time.
Optional early add-on if you overnighted in Flagstaff: Walnut Canyon or Sunset Crater (1 hr each). Night: Tucson.

### Day 10 — Mon Aug 24 · Saguaro NP
Both districts, split by the city:
- **West (Tucson Mountain District)** — denser saguaro forest, Valley View Overlook Trail, and the **Arizona-Sonora Desert Museum** next door (worth 3 hours on its own).
- **East (Rincon Mountain District)** — Cactus Forest Loop Drive, Freeman Homestead Trail.

Do the west district at sunrise, museum midday, east district at sunset. Anything strenuous must happen before 9am.
...
- Lightning on exposed rims (Mesa Verde, Canyon de Chelly, the dunes) is a real hazard — get below the ridgeline.

**Heat.** Tucson runs 100–105°F in late August; Petrified Forest and Chinle 95–100°F. Carry a gallon of water per person per day in the car, not just on the trail.

**Altitude.** Wolf Creek Pass is nearly 11,000 ft and Mesa Verde sits at 7,000–8,500 ft. Days 5–6 are where altitude headaches show up — drink more than feels necessary, go easy the first evening.

**Tribal land.** Days 7–8 are on the Navajo Nation. It observes Daylight Saving Time; the rest of Arizona does not — between roughly Monument Valley and Chinle your phone will jump an hour ahead. Alcohol is prohibited. Photography of people requires permission.
...
Grand Canyon South Rim is a 1.5-day detour off Day 9 (Flagstaff → Tusayan → back down through Sedona to Phoenix → Tucson). It adds roughly 250 mi and one night.
