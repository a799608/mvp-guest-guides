...
## Sleeping in rest areas — what's actually legal on this route

| State | Overnight in a rest area? |
|---|---|
| Ohio | Yes, Turnpike service plazas; 3-hr limit posted at some others but loosely enforced |
| Indiana / Illinois | Yes, 3-hr posted limit — the Illinois **Oases** on I-94 are 24-hr |
| **Wisconsin** | **No posted time limit.** Best rest areas on the route |
| **Minnesota** | Yes, 4 hrs posted; waysides are quiet and common |
| **South Dakota** | Yes, 10-hr limit. Very tolerant |
| **Wyoming** | Yes, no limit. Empty and dark |
| Colorado | Yes, but no camping; **national forest dispersed camping is better** |
| Utah / New Mexico / Arizona | Yes, generally tolerated |

**Better than rest areas where it's available:** dispersed camping on national forest and BLM land is free, legal, and there's an enormous amount of it on this route — Buffalo Gap National Grassland by the Badlands, Black Hills National Forest, White River National Forest around Aspen and Glenwood. 14-day limits, no facilities, no reservations, no one bothering you.

**Backups:** Walmart lots (call the store — some allow, some don't), Cracker Barrel, Love's/Pilot/Flying J truck stops. Truck stops are noisy and lit but always open and always safe.

Nothing on this trip needs to be booked for a bed. The only reservations are the three below.
...
**Sleep:** **Black Hills National Forest** — dispersed camping is free and legal along the forest roads off US-16 and the Needles Highway. The ceremony ends around 8:45pm, so scout a spot in daylight first. **Wind Cave NP** fits this morning if you want a fifth park; the tour is an hour.

### Day 6 — Thu Aug 20 · **Devils Tower** → Colorado Front Range
~530 mi with the stop — leave the Hills by 7.
**Devils Tower National Monument**, northwest of the Hills: an 867-ft laccolith of fluted columns standing alone above the Belle Fourche. Roosevelt made it the **first national monument in the country** in 1906. Walk the **Tower Trail**, a 1.3-mi paved loop around the base — there are usually climbers on it. Allow 1½–2 hours; the park pass covers it.
Then south on US-85 through Newcastle → Lusk → Cheyenne.
**Sleep:** Wyoming rest areas on US-85 or I-25 — **Chugwater** and **Wheatland** on I-25 are quiet. Or the Colorado welcome center at **Fort Collins** on I-25, which puts you an hour from the park gate.
...
**Sleep:** **White River National Forest** dispersed sites up the Crystal River valley toward Redstone, or the rest area on I-70 at Glenwood. Either way you're **an hour from Luke's**, which is the point.
...
**Maroon Bells** if the shuttle slot lines up, otherwise leave the day entirely to Luke. **Sleep:** Luke's, presumably.
...
A full day with nothing scheduled — Luke's to fill. The Silver Queen gondola, the Rio Grande Trail, Maroon Bells if you didn't get it Saturday. Second night at Luke's.

### Day 10 — Mon Aug 24 · Aspen → Mesa Verde NP
~330 mi, 7 hr — short miles, long day, and the best driving of the trip.
...
Get over the passes before the afternoon storms build. Arrive Cortez late afternoon — enough for the **Mesa Top Loop Road** and the **Cliff Palace overlook**, neither of which needs a ticket. **Sleep:** **Morefield Campground** inside Mesa Verde — cheap, rarely full, and it saves the drive back out. Otherwise national forest land east of Mancos.
...
Second night, same spot. Pack the car tonight.
...
**Moved:** Mesa Verde now comes *after* Aspen rather than before, and the Million Dollar Highway — which used to be the road *into* Aspen from Mesa Verde — becomes the road out, driven southbound instead.
